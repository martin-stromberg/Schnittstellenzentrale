...
Branch: `28-klickbare-baumelemente`

| Status | Schritt | Beschreibung | Artefakt |
|--------|---------|--------------|----------|
| [x] | 1 | Branch-Name ermitteln | – |
| [x] | 2 | Verzeichnisstruktur vorbereiten | `docs/features/28-klickbare-baumelemente/` |
...
| [ ] | 11 | Neue Nacharbeiten abschließen (2. continue.md) | `continue-done.md` |
